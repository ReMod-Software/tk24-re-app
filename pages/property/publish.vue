			...
			>
				...
				<div class="md:w-[20%] flex flex-col gap-4">
					...
					>
						...
						/>
						<input class="text-lg font-semibold text-center flex-grow h-full rounded-lg" placeholder="Enter phone number"/>
					</a>
					...
					>
						<img
							...
							class="h-10 w-10 bg-white rounded-l-md invert p-2"
						/>
                        <input class="text-lg font-semibold text-center flex-grow h-full rounded-lg" placeholder="Enter email address"/>
					...
					>
						<img
							...
							class="h-10 w-10 bg-white rounded-l-md invert p-2"
						/>
                        <input class="text-lg font-semibold text-center flex-grow h-full rounded-lg" placeholder="Enter map link"/>
