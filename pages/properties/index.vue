<template>
    <header class="p-4 flex justify-between bg-transparent backdrop-blur-lg sticky top-0 items-center">
        ...
        <div class="hidden md:flex w-auto md:w-[65%] h-full rounded-xl items-center px-12">
            ...
            <img src="/svg/search.svg" class="aspect-square bg-white invert h-full rounded-r-xl p-2" />
        </div>
                ...
                <div class="flex md:hidden ">
                    <div class="flex border-solid border-gray-500">
                        <div class="flex-col w-full flex">
                            <div class="flex justify-between items-center">
                                <h1 class="text-xl font-semibold text-gray-600 uppercase">Filters</h1>
                                <img class="h-12 ms-2 w-12 rounded-lg bg-white invert p-2" src="/svg/filter.svg"
                                    alt="Filter icon" />
                            </div>
...
const PROPERTIES: PropertyDetail[] = [
    ...
    {
        "title": "3 BHK Mansion",
        "description": "A 3 BHK mansion with sprawling gardens and opulent interiors, perfect for lavish living.",
        "image": "/photos/d3.jpg",
        "price": "₹ 5,00,00,000",
        "date": "15 February 2024",
