<template>
	<header class="p-4 flex justify-between bg-transparent backdrop-blur-sm sticky top-0 z-10 md:px-16">
		<NuxtLink to="/">
		...
		<nav class="hidden md:flex gap-6 justify-center items-center">
			...
			<NuxtImg class="h-8 w-8 cursor-pointer dark:invert" src="/svg/dark.svg" alt="Toggle Dark Mode"
				@click="changeColor" />
		</nav>
			<NuxtImg
		...
		<Sheet>
			...
			>
				...
				<div class="flex flex-col gap-4 py-8">
					<NuxtLink v-for="header in HEADER_NAV"
